...
public class TwitterLoginPlugin extends Callback<TwitterSession>
  ...
  private void authorize(Result result, MethodCall call) {
    ...
    initializeAuthClient(call).authorize(binding.getActivity(), this);
  }
  ...
  private TwitterAuthClient configureClient(String consumerKey, String consumerSecret) {
    ...
    TwitterConfig config = new TwitterConfig.Builder(binding.getActivity().getApplicationContext())
  ...
  private void logOut(Result result, MethodCall call) {
    CookieSyncManager.createInstance(binding.getActivity().getApplicationContext());
  ...
  @Override
  public void onAttachedToActivity(@NonNull ActivityPluginBinding newBinding) {
    binding = newBinding;
  ...
  @Override
  public void onReattachedToActivityForConfigChanges(@NonNull ActivityPluginBinding newBinding) {
    this.binding = newBinding;
    binding.addActivityResultListener(this::onActivityResult);
    binding.getActivity().getBaseContext();
  }
